...
body, div, dl, dt, dd, ul, li, h1, h2, h3, h4, h5, h6, pre, code, form, fieldset, legend, input, textarea, p, blockquote, th, td {margin: 0;padding: 0;outline:none;}
...
body {word-wrap: break-word; background:#e5e5e5;}
...
#col2{width:220px}
#col3{width:280px;}
#col4{width:320px;background-color: #fff;}
#col5{width:700px;}
#col6{width:622px}
#col7{width:830px}
#co18{width:1000px;}
...
#body-bg{padding:0 0 0 0;_padding:0;background:#f1f2f3;}
#page-wrap #main-wrap{margin:0 auto;text-align: left;width:1200px;position:relative;_margin:20px auto 0;}
...
#header{height:125px;width:100%;left:0;top:0;z-index:990;_overflow:hidden; background:#fff;}
#header .header-wrap{ width:100%; }
.header-wrap .head-bd{width:1200px; height:124px;margin-left:auto;margin-right:auto;padding-top:22px;z-index:999;}
...
.header-wrap .head-bd .nav{height:40px;margin: 0; float:left;}
.header-wrap .head-bd .nav li{float:left;height:39px;line-height:38px; font-size:20px; position:relative;font-family:黑体;}
#header .head-bd .nav li a{display:block;height:36px; line-height:38px; font-size:20px;margin-right:50px;font-family:黑体;}
#header .head-bd .nav .current a.app{ color:#0096e6;}
...
#header .head-bd li .num{background:#D30E00;padding:0;position:absolute;right:-5px;top:-5px;height:18px;min-width:18px;line-height:18px;display:block; text-align:center;color:#fff;cursor:pointer;border-radius:50%;-webkit-border-radius:50%;-khtml-border-radius:50%;-moz-border-radius:50%;font-size:13px;}
...
#header .head-bd  .search-btn{ z-index:5; position:absolute; right:155px;*right:205px;}
#header .head-bd .search{position:absolute;right:150px;*right:200px;top:14px;float:left;width:238px;_width:240px;height:30px; line-height:30px;background:#fff;border:#858585 1px solid;}
...
#header .head-bd .dorp-right .dropmenu{background:url(../image/layer_bg.png) repeat #F7F8FA;box-shadow: 1px 1px 5px gray;top:48px;right:-19px;position:absolute;width:320px;margin:10px 0 0 0;display:none;}
...
.head-bd #mod-search .search-box{background:#fff;border:1px solid #797979;z-index:1000;position:relative;}
...
.nav-left dd a:hover{background:#eb6100;color:#fff;}
...
.nav-left dd.current{background:#eb6100;}
...
.ico-add{background-position: 0 -37px;vertical-align::middle;_vertical-align:2px;}
...
#app_download{ position:fixed; bottom:30px;right:20px; }
...
.btn-grey-white{background:#EB6100;color:#fff;width:90px;height:36px; display:inline-block;line-height:36px;text-align:center;border:none;font-size:18px;border-radius:2px;-webkit-border-radius:2px;-moz-border-radius:2px;-khtml-border-radius:2px;}
...
.btns-red{width:78px;height:28px;line-height:28px;display:inline-block;text-align:center;font-size:14px;color:#EB6100;background:#fff; border:#EB6100 1px solid; cursor:pointer;}
.btns-red:hover{ background:#EB6100; color:#fff;}
...
.right-box li .user{width:70px;height:70px;}
...
.right-box ul li .face img{margin:0 0 3px 0;width:70px;height:70px; border-radius:50%; -webkit-border-radius:50%;-moz-border-radius:50%;}
...
.person-profile-top0{background:url(../image/space_1_1.jpg) no-repeat;height:142px;width:100%;margin-left:auto;margin-right:auto;position: relative;}
...
.post-union:hover,.send-email:hover,.pay-attention:hover,.pay-attention-hover{border:#eb6100 1px solid; color:#fff; background:#eb6100;}
...
.top-tab{margin:0 0 0px 0; border-top:none;font-size:20px; background:#fff;}
...
.top-tab li .current{ color:#eb6100; }
...
.relationship li{padding:20px;float:left;background:#fff;margin:20px;*width:500px;min-height:182px;border:#e5e6e7 1px solid;}
...
.search-tab li.current{color:#fff;background:#EB6100; border-radius:2px;-webkit-border-radius:2px;-moz-border-radius:2px;}
...
#search-boxs .main-top-search .btn-search {width:80px;height:40px;border:#EB6100 1px solid;border-radius:2px;-webkit-border-radius:2px;-moz-border-radius:2px; background:#fff;}

#search-boxs span{color:#999;line-height:40px;}
#search-boxs .main-top-search .btn-search span{text-align:center; color:#EB6100; display:block;line-height:38px;font-size:14px;}
...
.dp-cs {display:none;cursor:pointer;color:#EB6100;}
...
.ico-1-sina{background: url(../image/ico-sina.png) no-repeat;width:128px;height:40px;display:inline-block;cursor:pointer;}

.ico-weixin{background-position:-108px 0;margin-right:18px;}
a.ico-weixin:hover{background-position:-166px 0;}
.ico-1-weixin{background: url(../image/ico-weixin.png) no-repeat;width:128px;height:40px;display:inline-block;cursor:pointer;}

.ico-1-qzone{background: url(../image/ico-qq.png) no-repeat;width:128px;height:40px;display:inline-block;cursor:pointer;}
.ico-1-taobao{background: url(../image/ico-taobao.png) no-repeat;width:30px;height:30px;display:inline-block;cursor:pointer;}
...
.btn-green-big,.btn-green-big:hover{background:#EB6100;color:#fff;width:90px;height:36px; display:inline-block;line-height:36px;text-align:center;border:none;font-size:18px;border-radius:2px;-webkit-border-radius:2px;-moz-border-radius:2px;-khtml-border-radius:2px;cursor: pointer;font-family: "微软雅黑";}
.btn-green-big span,.btn-green-small span{color:#fff;}
.btn-green-small,.btn-green-small:hover{background:#EB6100;width:80px;height:30px; border:#EB6100 1px solid;display:inline-block;line-height:30px;font-size:14px;color:#fff;text-align:center;border-radius:2px;-webkit-border-radius:2px;-moz-border-radius:2px;-khtml-border-radius:2px;} 
...
.btn-orange-small,.btn-orange-small:hover{background:#eb6100;width:80px;height:30px; border:#eb6100 1px solid;display:inline-block;line-height:30px;font-size:14px;color:#fff;text-align:center;border-radius:2px;-webkit-border-radius:2px;-moz-border-radius:2px;-khtml-border-radius:2px;} 
.btn-att-orange,.btn-att-orange:hover{background:#eb6100;width:80px;height:14px; display:inline-block;line-height:14px;padding:5px 0;font-size:12px;color:#fff;text-align:center;border-radius:2px;-webkit-border-radius:2px;-moz-border-radius:2px;-khtml-border-radius:2px;}
...
.ico-mycourse{ background-position:-310px -235px;}
.ico-mycart{ background-position:-310px -261px;}

.ico-mysale{width:14px;height:14px; display:inline-block; background:url(../image/ico-mysale.png); vertical-align:middle;margin-right:10px;}
.ico-mycolumn{width:14px;height:14px; display:inline-block; background:url(../image/ico-mycolumn.png); vertical-align:middle;margin-right:10px;}
...
.diy-share .diy-share-cont{height:158px; width:100%;margin-bottom: 20px;border-left:1px solid #e5e6e7;}
.diy-share .diy-share-cont li{ width:33.23%;height:158px;border-right:#e5e6e7 1px solid; float:left; text-align:center;border-bottom:1px solid #e5e6e7;border-top:1px solid #e5e6e7;}
...
#weiba-top .app-tab-menu li .current{ border-bottom:none; color:#EB6100;}
...
.post-type .post-type-list .current a{ color:#EB6100;}
.post-list{ width:100%;}
...
.weiba-name{padding:6px 20px; background:#eb6100; display:block;}
...
.quick_post{width:100%;height:60px; display:block;line-height:60px; text-align:center;font-size:24px;color:#fff; background:#EB6100;margin-bottom:20px;}
.quick_post:hover{background:#EB6000;}
...
.poster-left{width:680px;margin: 0px auto;}
...
.postDetail{padding-top:20px;padding-right:0px;line-height:30px; font-size:16px;font-family:'微软雅黑';color:#333;letter-spacing:0.5px;margin: 0px auto;width:680px;}
.postDetail .pic{width:900px;height:600px;margin:20px auto;}
.postDetail .pic img{ width:100%;}
.poster-control{ padding:0px 0px 0px 0px;height:50px; width: 680px;margin: 0px auto;}
.big-post-btn{width:60px;height:25px;border:#8e8e8e 1px solid; display:inline-block; text-align:center;line-height:25px; font-size:12px; color:#333;}
.big-post-btn:hover,.big-post-btn-h:hover{ border:#EB6100 1px solid; color:#EB6100;}
.big-post-btn-h{width:60px;height:25px;border:#EB6100 1px solid; display:inline-block; text-align:center;line-height:25px; font-size:12px; color:#EB6100;margin-right:10px;}
.i-repost,
.i-store,
.i-praise,
a:hover .i-repost,
...
a:hover .praise,
.i-h-store,
.i-h-praise{ display:inline-block; vertical-align:middle;}
...
.cancel-share,.cancel-share:hover{*margin-top:-20px; font-size:0; background-image:url(../image/del.png); background-position:1px -50px;background-color:transparent; border:none; height:20px; width:20px;}
...
.weibaList li{width:399px; border-right:#f1f2f3 1px solid; border-bottom:#f1f2f3 1px solid; float:left;}
...
.myquanzi{width:150px;height:32px;border:1px solid #e6e6e6;text-align:center;line-height:32px;margin-top:20px;font-size:16px;margin-right:15px;background-image:url('../image/hui.png');background-repeat:no-repeat;background-position-x:right;float:left;}
.myquanzi_check{width:150px;height:32px;border:1px solid #e6e6e6;text-align:center;line-height:32px;margin-top:20px;font-size:16px;margin-right:15px;background-image:url('../image/hong.png');background-repeat:no-repeat;background-position-x:right;float:left;}
@charset "utf-8";
...
.feed_list .input_before1:after{clear:both;}
...
.feed_list .content p.info a:hover,.minh p.info a:hover{ color:#eb6100;}
...
.feed_list .digg-like-yes,.more-actions .digg-like-yes,.feed_list .digg-like-yes{color:#eb6100 !important}
...
.feed_list .contents a{color:#EB6100;font-size: 16px;}
.feed_list .contents p a.post-link{padding-left: 20px;background: url(../image/linkIcon.png) no-repeat left center;}
...
.input_tips{width:98.87%;height:80px;display:block;overflow-y:auto;padding:5px 0 5px 5px;font-size:14px;line-height:18px;cursor:text;outline:none;border:#ddd solid 1px;background:#fff;box-shadow:1px 1px 3px #dcdcdc inset;-moz-box-shadow:1px 1px 3px #dcdcdc inset;-webkit-box-shadow:1px 1px 3px #dcdcdc inset;}
...
.mod-feed-tab .inner-feed-nav .current a{color:#EB6100;}
...
.page a.current{padding:7px 10px;background:#EB6100;color:#fff; border:#EB6100;}
...
.app-tab-menu li a:link,.app-tab-menu li a:visited{height:17px;line-height:18px;display:inline-block;color:#999;font-size:18px;padding:7px 5px 20px 5px;}
...
.scrollarea .notitle{background:#fff !important;font-weight: normal !important;font-size: 14px;color: #535353; padding: 9px 15px;text-align: left; cursor:auto !important; position:relative;}
.scrollarea .comment{ background:#F7F8FA; margin:5px 0;}
.scrollarea .comment-mes{background:#fff; margin:0; line-height:22px;color:#999 !important}
.scrollarea .comment-mes a{color:#0096e6 !important}
.scrollarea .comment-mes a.view{color:#999 !important}
.scrollarea .content p.hd{ padding:0;}
.scrollarea .content p.hd .notify_time{font-size:12px;color:#888; padding:0 5px; position:absolute;top:0; right:0}
.scrollarea .feed_list .xline {margin: 0 20px;border-top:1px dashed #F3F3F3 ;}
...
.tab-menu .line-b,.tab-menu-box .line-b{background:#EB6100;position:absolute;width:58px;height:2px;left:0;bottom:0;padding:0 20px;}
.line-b-animate {position:relative; background:#fff;}
.tab-menu ul .current a{ background:#fff;color:#EB6100;}
